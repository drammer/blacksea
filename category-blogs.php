...
<section id="primary" class="content-area col-xs-8">
    <h1 class="news title-cat-header"><?php echo get_cat_name(21); ?></h1>
                ...
                foreach($blogs as $blog){
                    ...
                    <div class="col-xs-12 blog-item">
                        ...
                        <div class="item-content-blog col-xs-9">
                            <div class="title-blog-item"><?php echo $blog->post_title;?><span class="data-blog-item"><?php echo get_the_time('d.m.Y', $blog->ID); ?></span></div>
