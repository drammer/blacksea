...
<div id="primary" class="content-area single-news col-xs-8">
    ...
    <div id="content" class="site-content news-single" role="main">
        ...
        while ( have_posts() ) : the_post(); ?>
            ...
            <div class="col-xs-12 time-single-news"><span><?php echo the_time('G:i'); ?></span> <?php echo date_news(get_the_date('Y-m-d G:i'), 'text_mon_news'); ?></div>
    <div class="img-single-news-wrapp">
        <div class="img-single-news" style="background: url(<?php echo wp_get_attachment_url(get_post_thumbnail_id($singleID) ); ?>) no-repeat; background-size: 100% auto;
        "></div>
        <?php
 ...
 <?php
        ...
        <div class="col-xs-12 share-block-single-news">
            ...
            <div class="col-xs-5">Поделиться с друзьями:</div>
            <div class="col-xs-7">
